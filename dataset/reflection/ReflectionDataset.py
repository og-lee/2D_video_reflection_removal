...
class ReflectionDataset(VideoDataset):
    def __init__(self, root, mode='train', resize_mode=None, resize_shape=None, tw=8, max_temporal_gap=8, num_classes=2,
        ...
        self.shape = {}
        self.raw_samples = []
        super(ReflectionDataset, self).__init__(root, mode, resize_mode, resize_shape, tw, max_temporal_gap, num_classes)
...
if __name__ == '__main__':
    ...
    reflection = ReflectionDataset(root="/root/workplace/middle_project/",
